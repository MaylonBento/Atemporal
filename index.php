            ...
            <div class="categories">
                <ul>
                    <li id="special-currency">
                        <a href="./assets/promocao.php?pagina=1&categoria=promocao">
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=todos">
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=colecionaveis">
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=utensilios">
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=moveis">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=eletronicos">
                    ...
                    <li>
                        <a href="./assets/verTudo.php?pagina=1&categoria=vestuario">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
...
<script>
    function pegarId() {
        window.location.href = "./assets/produto.php";
    }
