...
<head>
    ...
    <!-- CSS do Index -->
    <link rel="stylesheet" href="./css/minhaConta.css?ver=<?= Date('his') ?>">
...
<script>
    ...
    dadosCadastrais.addEventListener("click", () => {
        window.location.href = 'minhaConta.php'
    });
    meusProdutos.addEventListener("click", () => {
        iframe.src = './iframe/meusProdutos.php'
    });
    minhasCompras.addEventListener("click", () => {
        iframe.src = './iframe/minhasCompras.php'
    });
    formasPagamento.addEventListener("click", () => {
        iframe.src = './iframe/formasPagamento.php'
    });
    chat.addEventListener("click", () => {
        iframe.src = './iframe/chat.php'
    });
</script>
