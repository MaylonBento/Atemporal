...
<head>
    ...
    <!-- CSS do Index -->
    <link rel="stylesheet" href="./css/sobreNos.css?ver=<?=Date('his')?>">



    <!-- Nome da Página -->
    <title>Sobre Nós - ATEMPORAL</title>
        ...
        <div class="main-bg">
            <div class="conteudo-1">
                <ul>
                    <h4>Sobre Nós</h4>
                    <p>
                        Somos um e-commerce de antiguidades e buscamos proporcionar aos nossos clientes, um 
                        ambiente seguro para compra e venda de seus objetos antigos, colecionáveis e decorativos.
                    </p>
            ...
            <div class="conteudo-2">
                <ul>
                    <h4>Quem Somos</h4>
                    <p>
                        A Atemporal Antiguidades é voltada ao comércio de antiguidades e colecionáveis, tendo como
                        objetivo oferecer a seus clientes a melhor experiência de compra via Internet.
                    </p>

                    <p>
                        Desde 2022 buscamos oferecer para amigos e clientes, objetos antigos, colecionáveis e 
                        decorativos, buscando sempre itens singulares e extraordinários para sua casa, coleção ou cenário.
                        O acervo atual é composto de milhares de itens.
                    </p>

                    <p>
                        Nossa página foi desenvolvida para proporcionar fácil navegação e visualização de cada item 
                        oferecido, com procedimentos de compra claros e seguros.
                    </p>

                    <p>
                        Os itens ofertados são únicos e, na maioria das vezes, insubstituíveis. 
                        Por esse motivo, não aceitamos reservas ou encomendas de produtos esgotados. 
                        As fotos que constam em cada anúncio são originais do item que está sendo vendido e que será entregue.
                    </p>

                    <p>
                        Todos os itens anunciados passam por uma rigorosa avaliação de veracidade, constam no estoque, estão 
                        prontos para serem enviados ao comprador e serão automaticamente baixados do site após a conclusão da venda. 
                        Ficaremos felizes em atendê-los, qualquer dúvida ou sugestões, entre em contato
                    </p>
            ...
            <div class="conteudo-3">
                <ul>
                    <h4>Curiosidades</h4>
                    <p>
                       Em processo... i'm the best SIIUUU
                    </p>
                </ul>
            </div>
        </div>
