...
<head>
    ...
    <!-- CSS do Index -->
    <link rel="stylesheet" href="./css/politicaPrivacidade.css?ver=<?=Date('his')?>">
    ...
    <main>
        <div class="conteudo-1">
            <ul>
                ...
                <p>
                    Quando você realiza uma compra na Atemporal Antiguidades, você nos fornece alguns dados pessoais com o objetivo de viabilizar a sua operação. Prezamos pela segurança dos seus dados, pelo respeito a sua privacidade e pela transparência com você e, por isso, dedicamos este documento para explicar como os seus dados pessoais serão tratados pelo site e quais são as medidas que aplicamos para mantê-los seguros.
                </p>
                    
                <p>
                    Antes de mais nada, nos apresentamos, nós somos a Atemporal Antiguidades, inscrito no CNPJ 00.789.123/0001-21, com sede na Cidade de São Bernardo do Campo, Estado de São Paulo, na Rua Mal. Deodoro, 1489, Centro, e segundo a definição trazida pela Lei Geral de Proteção de Dados “LGPD” (Lei Federal nº 13.709.2018), na maior parte do tempo seremos o controlador das suas informações, sendo assim, responsável por definir o que acontece com estes dados e por protegê-los.
                </p>
            </ul>
        </div>
