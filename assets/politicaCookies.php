...
<head>
    ...
    <!-- CSS do Index -->
    <link rel="stylesheet" href="./css/politicaCookies.css?ver=<?= Date('his') ?>">



    <!-- Nome da Página -->
    <title>Atemporal, Política Cookies</title>
    ...
    <main>
        ...
        <div class="conteudo-1">
            <ul>
                ...
                <p>
                    Nós utilizamos os cookies para personalizar anúncios, gerar dados estatísticos e garantir
                    que você tenha a melhor experiência na Atemporal Antiguidades!
                </p>
            </ul>
        </div>
