...
<head>
    ...
    <!-- CSS do Index -->
    <link rel="stylesheet" href="./css/produto.css?ver=<?= Date('his') ?>">
...
<body onload="montarProduto()">
    ...
    <main>
        ...
        <div class="produto-bg">
            <div class="produto-bloco" id="produto-bloco"></div>
            <div class="produto-data" id="produto-data"></div>
            <div class="produto-split">
                <div class="produto-img" id="produto-img"></div>
                <div class="produto-descricao" id="produto-descricao"></div>
            </div>
        </div>
