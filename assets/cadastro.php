            ...
            <div class="cliente-form" id="cliente-form" style="display: none;">
                <form action="./routines/cadastroModal.php" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="confirmarSenhaCliente" name="confirmarSenhaCliente" minlength="5" maxlength="15" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="nomeCliente" name="nomeCliente" minlength="3" maxlength="60" pattern="[A-Za-z].{3,}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="cpfCliente" class="form-label">CPF</label>
                        <input type="text" class="form-control" id="cpfCliente" name="cpfCliente" minlength="14" maxlength="14" required>
                    </div>

                    <div class="col-md-6">
                        <label for="foneCliente" class="form-label">Celular</label>
                        <input type="text" class="form-control" placeholder="com DDD" id="foneCliente" name="foneCliente" minlength="14" maxlength="14" required>
                    </div>

                    <div class="col-12 mb-2">
                        <label for="nascimentoCliente" class="form-label">Data de Nascimento</label>
                        <input type="date" class="form-control" id="nascimentoCliente" name="nascimentoCliente" required>
                    </div>

                    <div class="submit-container">
                        <div class="container d-grid">
                            <input type="submit" class="btn btn-lg btn-secondary" name="signUpCliente" value="Criar conta"></input>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="vendedor-form" id="vendedor-form" style="display: none;">
                <form action="./routines/cadastroModal.php" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="confirmarSenhaVendedor" name="confirmarSenhaVendedor" minlength="5" maxlength="15" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="nomeVendedor" name="nomeVendedor" minlength="3" maxlength="60" pattern="[A-Za-z].{3,}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="cpfVendedor" class="form-label">CPF</label>
                        <input type="text" class="form-control" id="cpfVendedor" name="cpfVendedor" minlength="14" maxlength="14" required>
                    </div>

                    <div class="col-md-6">
                        <label for="foneVendedor" class="form-label">Celular</label>
                        <input type="text" class="form-control" placeholder="com DDD" id="foneVendedor" name="foneVendedor" minlength="14" maxlength="14" required>
                    </div>

                    <div class="col-12 mb-4">
                        <label for="nascimentoVendedor" class="form-label">Data de Nascimento</label>
                        <input type="date" class="form-control" id="nascimentoVendedor" name="nascimentoVendedor" required>
                    </div>

                    <div class="submit-container">
                        <div class="container d-grid">
                            <input type="submit" class="btn btn-lg btn-secondary" name="signUpVendedor" value="Criar conta"></input>
                        </div>
                    </div>
                </form>
            </div>
